...
>(({ className, children, direction = "bottom", ...props }, ref) => {
  ...
  const styles = {
    bottom: "fixed inset-x-2 bottom-2 flex h-auto max-h-[60vh] md:h-auto outline-none flex-col z-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom duration-300",
