...
export const themes: Themes = {
  ...
  modern: {
    ...
    styles: {
      ...
      "--pf-title-gradient": "linear-gradient( to right, #dd7bbb 0%, #d79f1e 33%, #5a922c 66%, #4c7894 100% )",
      ...
      "--pf-gradient-blur": "0",
      "--pf-gradient-border":
        "radial-gradient(100px at var(--link-mouse-x) var(--link-mouse-y), #dd7bbb 0%, color-mix(in srgb, #dd7bbb, transparent 100%) 100%), radial-gradient(100px at calc(var(--link-mouse-x) - 20%) calc(var(--link-mouse-y) - 20%), #d79f1e 0%, color-mix(in srgb, #d79f1e, transparent 100%) 100%), radial-gradient(100px at calc(var(--link-mouse-x) + 20%) calc(var(--link-mouse-y) + 20%), #5a922c 0%, color-mix(in srgb, #5a922c, transparent 100%) 100%), radial-gradient(100px at calc(var(--link-mouse-x) - 10%) calc(var(--link-mouse-y) + 10%), #4c7894 0%, color-mix(in srgb, #4c7894, transparent 100%) 100%)",
    },
    fonts: {
